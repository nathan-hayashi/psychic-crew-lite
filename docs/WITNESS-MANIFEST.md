...
W-03	scripts/validate-lite.sh	class resolution produced a model for all	377627b50926b2b5
W-04	scripts/validate-lite.sh	every tracked hook is wired	377627b50926b2b5
...
W-08	scripts/check-sync.sh	severity vocabulary byte-identical	5f608605c73cf887
W-09	scripts/check-sync.sh	ADDED row names a parent path	5f608605c73cf887
W-10	scripts/check-sync.sh	every comparison below would be vacuous	5f608605c73cf887
...
W-13	scripts/validate-lite.sh	denial records carry an L-series phase	377627b50926b2b5
W-14	scripts/check-sync.sh	UNDECLARED Lite file(s)	5f608605c73cf887
W-15	scripts/verify.sh	rolling-median	421f435cab54036d
W-16	scripts/check-witness.sh	marker survives ONLY in a comment	701a0d35723c29df
W-17	scripts/verify.sh	history did NOT record	421f435cab54036d
W-18	scripts/validate-lite.sh	carried the prior next action forward verbatim	377627b50926b2b5
...
W-27	scripts/validate-lite.sh	release trail is absent or empty	377627b50926b2b5
...
W-34	scripts/validate-lite.sh	R-SD-1 VIOLATION	377627b50926b2b5
W-35	scripts/validate-lite.sh	the mirrored rule this assertion enforces is present	377627b50926b2b5
W-36	scripts/validate-lite.sh	rule 5 VIOLATION	377627b50926b2b5
W-37	scripts/validate-lite.sh	_sdstrip=	377627b50926b2b5
W-38	hooks/release-guard.sh	self_hits=$(	5055ab487fe2b652
W-39	scripts/check-sync.sh	UNDECLARED pack(s) on disk	5f608605c73cf887
W-40	scripts/check-sync.sh	a pack is Lite-only by definition	5f608605c73cf887
W-41	scripts/check-sync.sh	no 'why' is recorded	5f608605c73cf887
W-42	scripts/validate-lite.sh	A4a is recorded	377627b50926b2b5
W-43	scripts/gate-guard.sh	has no APPROVED row in	0afad32c9e7b1b2a
W-44	scripts/validate-lite.sh	refusal branch reads the ledger	377627b50926b2b5
W-45	scripts/validate-lite.sh	PUBLICATION RISK — pack workspace NOT ignored	377627b50926b2b5
W-46	scripts/validate-lite.sh	force-add would be caught here	377627b50926b2b5
W-47	scripts/validate-lite.sh	no second scale	377627b50926b2b5
W-48	scripts/check-sync.sh	packdirs=	5f608605c73cf887
```
