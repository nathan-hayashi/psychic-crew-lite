...
W-03	scripts/validate-lite.sh	class resolution produced a model for all	f6cb66df6bd7b607
W-04	scripts/validate-lite.sh	every tracked hook is wired	f6cb66df6bd7b607
...
W-13	scripts/validate-lite.sh	denial records carry an L-series phase	f6cb66df6bd7b607
...
W-18	scripts/validate-lite.sh	carried the prior next action forward verbatim	f6cb66df6bd7b607
...
W-27	scripts/validate-lite.sh	release trail is absent or empty	f6cb66df6bd7b607
...
W-34	scripts/validate-lite.sh	R-SD-1 VIOLATION	f6cb66df6bd7b607
W-35	scripts/validate-lite.sh	the mirrored rule this assertion enforces is present	f6cb66df6bd7b607
W-36	scripts/validate-lite.sh	rule 5 VIOLATION	f6cb66df6bd7b607
W-37	scripts/validate-lite.sh	_sdstrip=	f6cb66df6bd7b607
...
W-42	scripts/validate-lite.sh	A4a is recorded	f6cb66df6bd7b607
W-43	scripts/gate-guard.sh	has no APPROVED row in	0afad32c9e7b1b2a
W-44	scripts/validate-lite.sh	refusal branch reads the ledger	f6cb66df6bd7b607
W-45	scripts/validate-lite.sh	PUBLICATION RISK — pack workspace NOT ignored	f6cb66df6bd7b607
W-46	scripts/validate-lite.sh	force-add would be caught here	f6cb66df6bd7b607
W-47	scripts/validate-lite.sh	no second scale	f6cb66df6bd7b607
