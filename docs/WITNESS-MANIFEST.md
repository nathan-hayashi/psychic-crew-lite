...
W-03	scripts/validate-lite.sh	class resolution produced a model for all	6ea44bf53e687068
W-04	scripts/validate-lite.sh	every tracked hook is wired	6ea44bf53e687068
...
W-08	scripts/check-sync.sh	severity vocabulary byte-identical	bdce52fcfbb5d4f6
W-09	scripts/check-sync.sh	ADDED row names a parent path	bdce52fcfbb5d4f6
W-10	scripts/check-sync.sh	every comparison below would be vacuous	bdce52fcfbb5d4f6
...
W-13	scripts/validate-lite.sh	denial records carry an L-series phase	6ea44bf53e687068
W-14	scripts/check-sync.sh	UNDECLARED Lite file(s)	bdce52fcfbb5d4f6
...
W-18	scripts/validate-lite.sh	carried the prior next action forward verbatim	6ea44bf53e687068
...
W-27	scripts/validate-lite.sh	release trail is absent or empty	6ea44bf53e687068
...
W-34	scripts/validate-lite.sh	R-SD-1 VIOLATION	6ea44bf53e687068
W-35	scripts/validate-lite.sh	the mirrored rule this assertion enforces is present	6ea44bf53e687068
W-36	scripts/validate-lite.sh	rule 5 VIOLATION	6ea44bf53e687068
W-37	scripts/validate-lite.sh	_sdstrip=	6ea44bf53e687068
W-38	hooks/release-guard.sh	self_hits=$(	5055ab487fe2b652
W-39	scripts/check-sync.sh	UNDECLARED pack(s) on disk	bdce52fcfbb5d4f6
W-40	scripts/check-sync.sh	a pack is Lite-only by definition	bdce52fcfbb5d4f6
W-41	scripts/check-sync.sh	no 'why' is recorded	bdce52fcfbb5d4f6
W-42	scripts/validate-lite.sh	A4a is recorded	6ea44bf53e687068
W-43	scripts/gate-guard.sh	has no APPROVED row in	0afad32c9e7b1b2a
W-44	scripts/validate-lite.sh	refusal branch reads the ledger	6ea44bf53e687068
W-45	scripts/validate-lite.sh	PUBLICATION RISK — pack workspace NOT ignored	6ea44bf53e687068
W-46	scripts/validate-lite.sh	force-add would be caught here	6ea44bf53e687068
W-47	scripts/validate-lite.sh	no second scale	6ea44bf53e687068
W-48	scripts/check-sync.sh	packdirs=	bdce52fcfbb5d4f6
```
