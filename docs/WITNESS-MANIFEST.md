...
W-03	scripts/validate-lite.sh	class resolution produced a model for all	a20c82c41bd806f6
W-04	scripts/validate-lite.sh	every tracked hook is wired	a20c82c41bd806f6
...
W-13	scripts/validate-lite.sh	denial records carry an L-series phase	a20c82c41bd806f6
W-14	scripts/check-sync.sh	UNDECLARED Lite file(s)	5f608605c73cf887
W-15	scripts/verify.sh	rolling-median	421f435cab54036d
W-16	scripts/check-witness.sh	marker survives ONLY in a comment	ac98043905d59088
W-17	scripts/verify.sh	history did NOT record	421f435cab54036d
W-18	scripts/validate-lite.sh	carried the prior next action forward verbatim	a20c82c41bd806f6
...
W-27	scripts/validate-lite.sh	release trail is absent or empty	a20c82c41bd806f6
...
W-34	scripts/validate-lite.sh	R-SD-1 VIOLATION	a20c82c41bd806f6
W-35	scripts/validate-lite.sh	the mirrored rule this assertion enforces is present	a20c82c41bd806f6
W-36	scripts/validate-lite.sh	rule 5 VIOLATION	a20c82c41bd806f6
W-37	scripts/validate-lite.sh	_sdstrip=	a20c82c41bd806f6
...
W-42	scripts/validate-lite.sh	A4a is recorded	a20c82c41bd806f6
W-43	scripts/gate-guard.sh	has no APPROVED row in	0afad32c9e7b1b2a
W-44	scripts/validate-lite.sh	refusal branch reads the ledger	a20c82c41bd806f6
W-45	scripts/validate-lite.sh	PUBLICATION RISK — pack workspace NOT ignored	a20c82c41bd806f6
W-46	scripts/validate-lite.sh	force-add would be caught here	a20c82c41bd806f6
W-47	scripts/validate-lite.sh	no second scale	a20c82c41bd806f6
