...
**verified** — Layer 1 is behavioural. Layer 2 is the witness manifest: **44** attested corrections,
...
**verified** — `docs/SYNC-CORRELATION.md` holds **51** sync map rows under four relations:
